    ...
    return (
      <header className="main-header">
        <div className="main-header__wrapper">
          <svg height="40" className="octicon octicon-mark-github" viewBox="0 0 16 16" version="1.1"
          width="40" aria-hidden="true">
            <path fillRule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47
            7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48
          ...
          <strong className="app-title">Github Globo.com</strong>
        </div>
      </header>
    )
  }
